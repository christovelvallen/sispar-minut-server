...
export interface ApiDirectoryDirectory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    directory_posts: Attribute.Relation<
      'api::directory.directory',
      'oneToMany',
      'api::directory-post.directory-post'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiDirectoryPostDirectoryPost extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::directory-post.directory-post': ApiDirectoryPostDirectoryPost;
